...
This directory contains source files for the Akan language morphology
...
In order to compile and use Akan language morphology and dictionaries,
you need:
...
The Akan language sources can be acquired using [giella SVN
